function Hero() {
  return (
    <section className="h-[100vh] bg-[var(--hero-bg-tranparent)] flex flex-col items-center justify-center text-white relative">
      <div className="xl:grid grid-rows-1 grid-cols-2">
        ...
        <div className="max-w-8xl text-center lg:text-start">
          ...
          <div className="mt-7">
            <a href="/"><button className="cursor-pointer bg-[var(--primary-blue)] mr-5 my-4 px-7 py-4 rounded-full text-sm lg:text-lg tracking-wide">Get Quotes</button></a>
            <a href="/"><button className="cursor-pointer bg-[var(--primary-blue)] mr-5 my-4 px-7 py-4 rounded-full text-sm lg:text-lg tracking-wide">Get Started</button></a>
          </div>
        </div>
      </div>
    </section>
