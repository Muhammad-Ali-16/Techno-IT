                ...
                <div className='grid grid-rows-1 grid-cols-1 lg:grid-cols-3 xl:grid-cols-3 place-items-center gap-12'>
                    ...
                    <form className='w-full col-span-2'>
                        <div class="space-y-12">
                            ...
                            <div class="mt-10 grid grid-rows-1 grid-cols-2 gap-x-6 gap-y-8">

                                <div class="col-span-full lg:col-span-1">
                                    <div class="mt-1">
                                        <input required placeholder='Name' id="name" type="text" name="name" autocomplete="name" class="block w-full rounded-md bg-[var(--input-bg)] px-3 py-4 text-[var(--text-primary)] outline-1 -outline-offset-1 outline-[var(--text-primary)]/15 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-[#cb954575] sm:text-sm/6" />
                                    </div>
                                </div>

                                <div class="col-span-full lg:col-span-1">
                                    <div class="mt-1">
                                        <input required placeholder='Email' id="email" type="email" name="email" autocomplete="email" class="block w-full rounded-md bg-[var(--input-bg)] px-3 py-4 text-[var(--text-primary)] outline-1 -outline-offset-1 outline-[var(--text-primary)]/15 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-[#cb954575] sm:text-sm/6" />
                                    </div>
                                </div>

                                <div class="col-span-full">
                                    <div class="mt-1">
                                        <input required placeholder='Subject' id="subject" type="text" name="subject" autocomplete="subject" class="block w-full rounded-md bg-[var(--input-bg)] px-3 py-4 text-[var(--text-primary)] outline-1 -outline-offset-1 outline-[var(--text-primary)]/15 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-[#cb954575] sm:text-sm/6" />
                                    </div>
                                </div>

                                <div class="col-span-full">
                                    <div class="mt-1">
                                        <textarea id="message" required placeholder='Write Your Message' name="message" rows="3" class="block w-full rounded-md bg-[var(--input-bg)] px-3 py-4 text-[var(--text-primary)] outline-1 -outline-offset-1 outline-[var(--text-primary)]/15 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-[#cb954575] sm:text-sm/6"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
